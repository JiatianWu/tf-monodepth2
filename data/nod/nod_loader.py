...
class nod_loader(object):
    ...
    def load_image_raw(self, drive, frame_id):
        img_file = self.dataset_dir + drive + '/' + frame_id + '.pgm'
        img = Image.open(img_file)
        return img

    def load_intrinsics_raw(self, drive, frame_id):
        P_rect = np.eye(3, 3)
        P_rect[0,0] = 238.52264234
        P_rect[0,2] = 332.14860019
        P_rect[1,1] = 238.15329999
        P_rect[1,2] = 195.73207196
