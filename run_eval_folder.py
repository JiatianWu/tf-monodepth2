...
class App:
    ...
    def __init__(self, args):
        ...
        folder_path = '/home/nod/datasets/weanhall/rectified'
    ...
    def save_rgbd_data(self, rgb, depth, idx):
        ...
        data_file_name = '/home/nod/datasets/weanhall/eval_model_data/' + str(idx).zfill(6) + '.pkl'
    ...
    def run(self):
        ...
        while not self.flag_exit:
            ...
            idx += 1
            # Image.fromarray(toshow_image).save('/home/nod/datasets/weanhall/eval/' + str(idx).zfill(6) + '.jpg')
