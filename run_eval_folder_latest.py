...
class App:
    ...
    def __init__(self, args):
        ...
        datasource_path = '/home/nod/datasets/nyudepthV2/test_kitchen/color'
            ...
            if self.eval is False:
                ...
                if self.enable_filter:
                    ...
                    if math.isnan(depth_map.max()):
                        idx += 1
                        continue
                    Image.fromarray(np.array(depth_map, np.uint16)).save('/home/nod/datasets/nyudepthV2/test_kitchen/depth/' + str(idx).zfill(6) + '.png')
            else:
